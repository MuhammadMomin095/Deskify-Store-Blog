...
const Card = () => {
  return (
    <div className="hero text-left bg-black text-white relative py-32 px-4 sm:px-16 md:px-32">
      <img
        src="bg/3.jpg"
      ...
      <section className="relative z-10 text-gray-300 text-center">
        ...
        {/* Blog Cards */}
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 items-start justify-center p-4 sm:p-6 md:p-8 rounded-lg mt-16">
          {/* Card 1 */}
          <div className="card bg-gradient-to-r from-[#1D1915] via-[#3A3126] to-[#1D1915] shadow-md rounded-lg p-6 text-center hover:shadow-xl transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-1 animate-fadeInUp min-h-[350px]" style={{ boxShadow: "-20px -20px 28px #C1AA90, 20px 20px 28px #C1AA90" }}>
            ...
            <p className="text-[#C1AA90] mb-4">
              Deskify offers a wide variety of innovative products designed to optimize your workspace. From ergonomic desks to modern office accessories, discover products that blend functionality with style.
            </p>
          ...
          <div className="card bg-gradient-to-r from-[#1D1915] via-[#3A3126] to-[#1D1915] shadow-md rounded-lg p-6 text-center hover:shadow-xl transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-rotate-1 animate-fadeInUp min-h-[350px]" style={{ boxShadow: "-20px -20px 28px #C1AA90, 20px 20px 28px #C1AA90" }}>
            ...
            <p className="text-[#C1AA90] mb-4">
              In our first blog post, we dive into the importance of creating a comfortable and productive workspace. Learn how Deskify’s ergonomic furniture and accessories can help you improve your posture and overall well-being.
            </p>
          ...
          <div className="card bg-gradient-to-r from-[#1D1915] via-[#3A3126] to-[#1D1915] shadow-md rounded-lg p-6 text-center hover:shadow-xl transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-1 animate-fadeInUp min-h-[350px]" style={{ boxShadow: "-20px -20px 28px #C1AA90, 20px 20px 28px #C1AA90" }}>
            ...
            <p className="text-[#C1AA90] mb-4">
              Our second blog post takes a deep dive into the world of sustainable office furniture. Deskify explores eco-friendly materials, energy-efficient designs, and how choosing sustainable office solutions can contribute to a greener planet.
            </p>
          ...
          <div className="card bg-gradient-to-r from-[#1D1915] via-[#3A3126] to-[#1D1915] shadow-md rounded-lg p-6 text-center hover:shadow-xl transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-1 animate-fadeInUp min-h-[350px]" style={{ boxShadow: "-20px -20px 28px #C1AA90, 20px 20px 28px #C1AA90" }}>
            ...
            <p className="text-[#C1AA90] mb-4">
              In this post, we explore the latest trends in home office design. Deskify shares tips on how to create a functional and stylish workspace that boosts productivity and enhances creativity.
            </p>
          ...
          <div className="card bg-gradient-to-r from-[#1D1915] via-[#3A3126] to-[#1D1915] shadow-md rounded-lg p-6 text-center hover:shadow-xl transition-transform duration-300 ease-in-out transform hover:scale-105 hover:rotate-1 animate-fadeInUp min-h-[350px]" style={{ boxShadow: "-20px -20px 28px #C1AA90, 20px 20px 28px #C1AA90" }}>
            ...
            <p className="text-[#C1AA90] mb-4">
              In our fourth blog post, we discuss the importance of organizing your workspace for maximum efficiency. Deskify offers strategies to declutter your desk, streamline your workflow, and create a more organized and efficient work environment.
            </p>
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-[#1D1915] via-[#3A3126] to-[#1D1915] p-8 rounded-lg justify-center" style={{ boxShadow: "-20px -20px 28px #C1AA90, 20px 20px 28px #C1AA90" }}>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-12">
            <div className="stats-item text-center mb-6 sm:mb-0">
              <h4 className="text-4xl sm:text-5xl font-semibold text-blue-500">500+</h4>
              <p className="text-[#C1AA90]">Products Sold</p>
            </div>
            <div className="stats-item text-center mb-6 sm:mb-0">
              <h4 className="text-4xl sm:text-5xl font-semibold text-blue-500">1000+</h4>
              <p className="text-[#C1AA90]">Happy Customers</p>
            </div>
            <div className="stats-item text-center">
              <h4 className="text-4xl sm:text-5xl font-semibold text-blue-500">99%</h4>
        ...
        <div className="mt-12 text-center">
          <a href="posts/blogs" className="bg-black text-white font-bold py-3 px-6 rounded-full transition duration-300" style={{ boxShadow: "6px 6px 10px white" }}>
            + Explore More Blog
          </a>
        </div>
      </section>
